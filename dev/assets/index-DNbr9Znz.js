...
`)}catch(l){return console.error("Error generating geometry or STL:",l),null}},createInitialMesh(){const t=this.generateSTL(this.width,this.depth,this.safety,this.bottomHeight,this.topHeight,this.borderThickness);if(!t)return;this.stlData=t;const n=new Td().parse(t),i=new Jw({color:11066076,roughness:.6,metalness:.1});this.mesh=new vi(n,i),this.scene.add(this.mesh);const s=new Md(n),r=new pf({color:3355443});this.edgeLines=new yd(s,r),this.scene.add(this.edgeLines)},rebuildMesh(){this.mesh&&(this.scene.remove(this.mesh),this.mesh.geometry.dispose()),this.edgeLines&&(this.scene.remove(this.edgeLines),this.edgeLines.geometry.dispose()),this.createInitialMesh()},animateDimensionsTransition(t,e){const n=performance.now(),i=this.tweenDuration,s=new Td,r=o=>{const a=Math.min((o-n)/i,1),l={};for(const f of Object.keys(t))l[f]=t[f]+(e[f]-t[f])*a;const c=this.generateSTL(l.width,l.depth,l.safety,l.bottomHeight,l.topHeight,l.borderThickness);if(c){const f=s.parse(c);this.mesh&&(this.mesh.geometry.dispose(),this.mesh.geometry=f),this.edgeLines&&(this.scene.remove(this.edgeLines),this.edgeLines.geometry.dispose());const u=new Md(f);this.edgeLines=new yd(u,new pf({color:3355443})),this.scene.add(this.edgeLines),this.stlData=c}a<1?requestAnimationFrame(r):(this.currentWidth=e.width,this.currentDepth=e.depth,this.currentSafety=e.safety,this.currentBottomHeight=e.bottomHeight,this.currentTopHeight=e.topHeight,this.currentBorderThickness=e.borderThickness)};requestAnimationFrame(r)},initScene(){this.scene=new Zw,this.camera=new bn(75,600/500,.1,1e3),this.camera.position.set(0,150,100),this.camera.up.set(0,0,1),this.camera.lookAt(0,0,10),this.renderer=new g0({canvas:this.$refs.canvas,antialias:!0}),this.renderer.setSize(600,500),this.renderer.setClearColor(16250871),this.scene.add(new oT(7368816,.5));const n=new iT(16777215,4473924,.6);n.position.set(0,200,0),this.scene.add(n);const i=new wd(16777215,.8);i.position.set(1,1,1).normalize(),this.scene.add(i);const s=new wd(16777215,.4);s.position.set(-1,-1,1).normalize(),this.scene.add(s),this.controls=new aT(this.camera,this.renderer.domElement),this.controls.rotateSpeed=1,this.controls.zoomSpeed=1.2,this.controls.panSpeed=.8,this.controls.dynamicDampingFactor=.05,this.controls.minPolarAngle=Math.PI/4,this.controls.maxPolarAngle=Math.PI/2,this.animate()},animate(){requestAnimationFrame(this.animate.bind(this)),this.controls.update(),this.renderer.render(this.scene,this.camera)},downloadSTL(){if(!this.stlData)return;const t=new Blob([this.stlData],{type:"application/octet-stream"}),e=document.createElement("a");e.href=URL.createObjectURL(t),e.download=`SynthArmor_cover_${this.width}x${this.depth}_safetyOffset${this.safety}_bottomHeight${this.bottomHeight}_topHeight${this.topHeight}_borderThickness${this.borderThickness}.stl`,e.click()}}},Oz={class:"mt-2 mb-2 flex flex-col items-center"},Hz={class:"w-full max-w-[600px] flex flex-col items-center"},Bz={ref:"canvas",class:"rounded-md w-full max-w-[600px] border border-gray-300 border-t-0 border-b-0"};function zz(t,e,n,i,s,r){return tn(),mn("div",Oz,[j("div",Hz,[e[0]||(e[0]=j("div",{class:"bg-gray-300 h-[1px] w-[95%]"},null,-1)),j("canvas",Bz,null,512),e[1]||(e[1]=j("div",{class:"bg-gray-300 h-[1px] w-[95%]"},null,-1))])])}const Vz=pr(Fz,[["render",zz]]),kz={name:"FAQ",data(){return{faqs:[{question:"What is this?",answer:"This web app lets you quickly generate a custom 3D model for gear cover protection. Simply enter your equipment’s dimensions, adjust a safety offset if needed, and download an STL file ready for 3D printing.",open:!1},{question:"How does it work?",answer:`
          ...
          `,open:!1},{question:"A Word of Caution",answer:"Please note that you are solely responsible for ensuring that the generated model fits your machine. Always double-check the dimensions before printing.",open:!1}]}},methods:{toggle(t){this.faqs[t].open=!this.faqs[t].open}}},Gz={class:"w-full max-w-[600px] mt-8"},$z=["onClick"],Wz={class:"text-lg font-medium text-gray-700"},Xz={class:"px-6 py-4 bg-gray-50"},qz=["innerHTML"];function jz(t,e,n,i,s,r){return tn(),mn("div",Gz,[e[1]||(e[1]=j("h2",{class:"text-2xl font-bold mb-6 text-gray-800 text-center"},"FAQ",-1)),(tn(!0),mn(Nn,null,Gv(s.faqs,(o,a)=>(tn(),mn("div",{key:a,class:"mb-4 border border-gray-200 rounded-lg overflow-hidden shadow-sm"},[j("button",{onClick:l=>r.toggle(a),class:"w-full flex items-center justify-between px-6 py-4 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"},[j("span",Wz,Dm(o.question),1),(tn(),mn("svg",{class:Ga(["w-5 h-5 text-gray-500 transform transition-transform duration-300",{"rotate-180":o.open}]),fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},e[0]||(e[0]=[j("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M19 9l-7 7-7-7"},null,-1)]),2))],8,$z),bt(Gx,{name:"faq-collapse"},{default:ng(()=>[Ge(j("div",Xz,[j("div",{innerHTML:o.answer,class:"text-gray-600"},null,8,qz)],512),[[Yx,o.open]])]),_:2},1024)]))),128))])}const Yz=pr(kz,[["render",jz],["__scopeId","data-v-9b75b70f"]]),Zz={name:"HoleOptionsForm",props:{initialEnableBackHole:{type:Boolean,default:!1},initialBackHoleXOffset:{type:Number,default:0},initialBackHoleWidth:{type:Number,default:55},initialBackHoleHeight:{type:Number,default:10},initialEnableFrontHole:{type:Boolean,default:!1},initialFrontHoleXOffset:{type:Number,default:0},initialFrontHoleWidth:{type:Number,default:55},initialFrontHoleHeight:{type:Number,default:10},initialEnableRightHole:{type:Boolean,default:!1},initialRightHoleXOffset:{type:Number,default:0},initialRightHoleWidth:{type:Number,default:55},initialRightHoleHeight:{type:Number,default:10},initialEnableLeftHole:{type:Boolean,default:!1},initialLeftHoleXOffset:{type:Number,default:0},initialLeftHoleWidth:{type:Number,default:55},initialLeftHoleHeight:{type:Number,default:10}},data(){return{local:{enableBackHole:this.initialEnableBackHole,backHoleXOffset:this.initialBackHoleXOffset,backHoleWidth:this.initialBackHoleWidth,backHoleHeight:this.initialBackHoleHeight,enableFrontHole:this.initialEnableFrontHole,frontHoleXOffset:this.initialFrontHoleXOffset,frontHoleWidth:this.initialFrontHoleWidth,frontHoleHeight:this.initialFrontHoleHeight,enableRightHole:this.initialEnableRightHole,rightHoleXOffset:this.initialRightHoleXOffset,rightHoleWidth:this.initialRightHoleWidth,rightHoleHeight:this.initialRightHoleHeight,enableLeftHole:this.initialEnableLeftHole,leftHoleXOffset:this.initialLeftHoleXOffset,leftHoleWidth:this.initialLeftHoleWidth,leftHoleHeight:this.initialLeftHoleHeight}}},watch:{local:{deep:!0,handler(){this.$emit("update-hole-options",{...this.local})}}}},Kz={class:"mb-6 p-4 border border-gray-300 rounded"},Jz={class:"grid grid-cols-1 md:grid-cols-2 gap-4"},Qz={class:"inline-flex items-center mb-2"},e4={key:0,class:"space-y-2"},t4={class:"flex items-center space-x-2"},n4={class:"flex items-center space-x-2"},i4={class:"flex items-center space-x-2"},s4={class:"inline-flex items-center mb-2"},r4={key:0,class:"space-y-2"},o4={class:"flex items-center space-x-2"},a4={class:"flex items-center space-x-2"},l4={class:"flex items-center space-x-2"},c4={class:"inline-flex items-center mb-2"},f4={key:0,class:"space-y-2"},u4={class:"flex items-center space-x-2"},h4={class:"flex items-center space-x-2"},d4={class:"flex items-center space-x-2"},p4={class:"inline-flex items-center mb-2"},m4={key:0,class:"space-y-2"},g4={class:"flex items-center space-x-2"},_4={class:"flex items-center space-x-2"},v4={class:"flex items-center space-x-2"};function x4(t,e,n,i,s,r){return tn(),mn("fieldset",Kz,[e[56]||(e[56]=j("legend",{class:"px-2 text-lg font-semibold"},"Hole Options",-1)),j("div",Jz,[j("div",null,[j("div",Qz,[Ge(j("input",{type:"checkbox","onUpdate:modelValue":e[0]||(e[0]=o=>s.local.enableBackHole=o),class:"mr-2"},null,512),[[Ao,s.local.enableBackHole]]),e[28]||(e[28]=j("span",{class:"text-sm font-medium text-gray-700"},"Enable Back Hole",-1))]),s.local.enableBackHole?(tn(),mn("div",e4,[j("div",t4,[e[29]||(e[29]=j("label",{class:"w-24 text-sm text-gray-700"},"Position:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[1]||(e[1]=o=>s.local.backHoleXOffset=o),min:"-100",max:"100",step:"1",class:"flex-1"},null,512),[[Je,s.local.backHoleXOffset,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[2]||(e[2]=o=>s.local.backHoleXOffset=o),min:"-100",max:"100",step:"1",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.backHoleXOffset,void 0,{number:!0}]]),e[30]||(e[30]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",n4,[e[31]||(e[31]=j("label",{class:"w-24 text-sm text-gray-700"},"Width:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[3]||(e[3]=o=>s.local.backHoleWidth=o),min:"0",max:"300",step:"1",class:"flex-1"},null,512),[[Je,s.local.backHoleWidth,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[4]||(e[4]=o=>s.local.backHoleWidth=o),min:"0",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.backHoleWidth,void 0,{number:!0}]]),e[32]||(e[32]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",i4,[e[33]||(e[33]=j("label",{class:"w-24 text-sm text-gray-700"},"Height:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[5]||(e[5]=o=>s.local.backHoleHeight=o),min:"0",max:"300",step:"1",class:"flex-1"},null,512),[[Je,s.local.backHoleHeight,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[6]||(e[6]=o=>s.local.backHoleHeight=o),min:"0",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.backHoleHeight,void 0,{number:!0}]]),e[34]||(e[34]=j("span",{class:"text-sm text-gray-700"},"mm",-1))])])):To("",!0)]),j("div",null,[j("div",s4,[Ge(j("input",{type:"checkbox","onUpdate:modelValue":e[7]||(e[7]=o=>s.local.enableFrontHole=o),class:"mr-2"},null,512),[[Ao,s.local.enableFrontHole]]),e[35]||(e[35]=j("span",{class:"text-sm font-medium text-gray-700"},"Enable Front Hole",-1))]),s.local.enableFrontHole?(tn(),mn("div",r4,[j("div",o4,[e[36]||(e[36]=j("label",{class:"w-24 text-sm text-gray-700"},"Position:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[8]||(e[8]=o=>s.local.frontHoleXOffset=o),min:"-100",max:"100",step:"1",class:"flex-1"},null,512),[[Je,s.local.frontHoleXOffset,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[9]||(e[9]=o=>s.local.frontHoleXOffset=o),min:"-100",max:"100",step:"1",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.frontHoleXOffset,void 0,{number:!0}]]),e[37]||(e[37]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",a4,[e[38]||(e[38]=j("label",{class:"w-24 text-sm text-gray-700"},"Width:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[10]||(e[10]=o=>s.local.frontHoleWidth=o),min:"0",max:"300",step:"1",class:"flex-1"},null,512),[[Je,s.local.frontHoleWidth,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[11]||(e[11]=o=>s.local.frontHoleWidth=o),min:"0",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.frontHoleWidth,void 0,{number:!0}]]),e[39]||(e[39]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",l4,[e[40]||(e[40]=j("label",{class:"w-24 text-sm text-gray-700"},"Height:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[12]||(e[12]=o=>s.local.frontHoleHeight=o),min:"0",max:"300",step:"1",class:"flex-1"},null,512),[[Je,s.local.frontHoleHeight,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[13]||(e[13]=o=>s.local.frontHoleHeight=o),min:"0",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.frontHoleHeight,void 0,{number:!0}]]),e[41]||(e[41]=j("span",{class:"text-sm text-gray-700"},"mm",-1))])])):To("",!0)]),j("div",null,[j("div",c4,[Ge(j("input",{type:"checkbox","onUpdate:modelValue":e[14]||(e[14]=o=>s.local.enableRightHole=o),class:"mr-2"},null,512),[[Ao,s.local.enableRightHole]]),e[42]||(e[42]=j("span",{class:"text-sm font-medium text-gray-700"},"Enable Right Hole",-1))]),s.local.enableRightHole?(tn(),mn("div",f4,[j("div",u4,[e[43]||(e[43]=j("label",{class:"w-24 text-sm text-gray-700"},"Position:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[15]||(e[15]=o=>s.local.rightHoleXOffset=o),min:"-100",max:"100",step:"1",class:"flex-1"},null,512),[[Je,s.local.rightHoleXOffset,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[16]||(e[16]=o=>s.local.rightHoleXOffset=o),min:"-100",max:"100",step:"1",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.rightHoleXOffset,void 0,{number:!0}]]),e[44]||(e[44]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",h4,[e[45]||(e[45]=j("label",{class:"w-24 text-sm text-gray-700"},"Width:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[17]||(e[17]=o=>s.local.rightHoleWidth=o),min:"0",max:"300",step:"1",class:"flex-1"},null,512),[[Je,s.local.rightHoleWidth,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[18]||(e[18]=o=>s.local.rightHoleWidth=o),min:"0",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.rightHoleWidth,void 0,{number:!0}]]),e[46]||(e[46]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",d4,[e[47]||(e[47]=j("label",{class:"w-24 text-sm text-gray-700"},"Height:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[19]||(e[19]=o=>s.local.rightHoleHeight=o),min:"0",max:"300",step:"1",class:"flex-1"},null,512),[[Je,s.local.rightHoleHeight,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[20]||(e[20]=o=>s.local.rightHoleHeight=o),min:"0",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.rightHoleHeight,void 0,{number:!0}]]),e[48]||(e[48]=j("span",{class:"text-sm text-gray-700"},"mm",-1))])])):To("",!0)]),j("div",null,[j("div",p4,[Ge(j("input",{type:"checkbox","onUpdate:modelValue":e[21]||(e[21]=o=>s.local.enableLeftHole=o),class:"mr-2"},null,512),[[Ao,s.local.enableLeftHole]]),e[49]||(e[49]=j("span",{class:"text-sm font-medium text-gray-700"},"Enable Left Hole",-1))]),s.local.enableLeftHole?(tn(),mn("div",m4,[j("div",g4,[e[50]||(e[50]=j("label",{class:"w-24 text-sm text-gray-700"},"Position:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[22]||(e[22]=o=>s.local.leftHoleXOffset=o),min:"-100",max:"100",step:"1",class:"flex-1"},null,512),[[Je,s.local.leftHoleXOffset,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[23]||(e[23]=o=>s.local.leftHoleXOffset=o),min:"-100",max:"100",step:"1",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.leftHoleXOffset,void 0,{number:!0}]]),e[51]||(e[51]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",_4,[e[52]||(e[52]=j("label",{class:"w-24 text-sm text-gray-700"},"Width:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[24]||(e[24]=o=>s.local.leftHoleWidth=o),min:"0",max:"300",step:"1",class:"flex-1"},null,512),[[Je,s.local.leftHoleWidth,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[25]||(e[25]=o=>s.local.leftHoleWidth=o),min:"0",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.leftHoleWidth,void 0,{number:!0}]]),e[53]||(e[53]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",v4,[e[54]||(e[54]=j("label",{class:"w-24 text-sm text-gray-700"},"Height:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[26]||(e[26]=o=>s.local.leftHoleHeight=o),min:"0",max:"300",step:"1",class:"flex-1"},null,512),[[Je,s.local.leftHoleHeight,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[27]||(e[27]=o=>s.local.leftHoleHeight=o),min:"0",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.leftHoleHeight,void 0,{number:!0}]]),e[55]||(e[55]=j("span",{class:"text-sm text-gray-700"},"mm",-1))])])):To("",!0)])])])}const y4=pr(Zz,[["render",x4]]),M4="/SynthArmor/dev/SynthArmor_logo.png",E4={name:"App",components:{BasicForm:R1,AdvancedForm:H1,ModelViewer:Vz,FAQ:Yz,HoleOptionsForm:y4},data(){return{width:155,depth:105,safety:0,bottomHeight:15,topHeight:25,borderThickness:2.5,enableBackHole:!1,backHoleXOffset:0,backHoleWidth:55,backHoleHeight:10,enableFrontHole:!1,frontHoleXOffset:0,frontHoleWidth:55,frontHoleHeight:10,enableRightHole:!1,rightHoleXOffset:0,rightHoleWidth:55,rightHoleHeight:10,enableLeftHole:!1,leftHoleXOffset:0,leftHoleWidth:55,leftHoleHeight:10}},methods:{updateBasic({width:t,depth:e,safety:n}){this.width=t,this.depth=e,this.safety=n},updateAdvanced({bottomHeight:t,topHeight:e,borderThickness:n}){this.bottomHeight=t,this.topHeight=e,this.borderThickness=n},updateHoleOptions(t){Object.assign(this,t)},downloadModel(){this.$refs.modelViewer.downloadSTL()}}},S4={class:"max-w-3xl mx-auto min-h-screen flex flex-col justify-center items-center p-6"},b4={class:"w-full max-w-[600px] bg-white rounded shadow p-6"};function w4(t,e,n,i,s,r){const o=br("BasicForm"),a=br("ModelViewer"),l=br("AdvancedForm"),c=br("HoleOptionsForm"),f=br("FAQ");return tn(),mn("div",S4,[e[1]||(e[1]=j("img",{src:M4,alt:"SynthArmor Logo",class:"w-40 mb-4"},null,-1)),e[2]||(e[2]=j("div",{class:"mb-8 text-center"},[j("p",{class:"text-gray-600"}," Modify the dimensions of a 3D model and download your custom design instantly. ")],-1)),j("div",b4,[bt(o,{"initial-width":s.width,"initial-depth":s.depth,"initial-safety":s.safety,onUpdateDimensions:r.updateBasic},null,8,["initial-width","initial-depth","initial-safety","onUpdateDimensions"]),bt(a,{ref:"modelViewer",width:s.width,depth:s.depth,safety:s.safety,"bottom-height":s.bottomHeight,"top-height":s.topHeight,"border-thickness":s.borderThickness,"enable-back-hole":s.enableBackHole,"back-hole-x-offset":s.backHoleXOffset,"back-hole-width":s.backHoleWidth,"back-hole-height":s.backHoleHeight,"enable-front-hole":s.enableFrontHole,"front-hole-x-offset":s.frontHoleXOffset,"front-hole-width":s.frontHoleWidth,"front-hole-height":s.frontHoleHeight,"enable-right-hole":s.enableRightHole,"right-hole-x-offset":s.rightHoleXOffset,"right-hole-width":s.rightHoleWidth,"right-hole-height":s.rightHoleHeight,"enable-left-hole":s.enableLeftHole,"left-hole-x-offset":s.leftHoleXOffset,"left-hole-width":s.leftHoleWidth,"left-hole-height":s.leftHoleHeight},null,8,["width","depth","safety","bottom-height","top-height","border-thickness","enable-back-hole","back-hole-x-offset","back-hole-width","back-hole-height","enable-front-hole","front-hole-x-offset","front-hole-width","front-hole-height","enable-right-hole","right-hole-x-offset","right-hole-width","right-hole-height","enable-left-hole","left-hole-x-offset","left-hole-width","left-hole-height"]),bt(l,{"initial-bottom-height":s.bottomHeight,"initial-top-height":s.topHeight,"initial-border-thickness":s.borderThickness,onUpdateAdvanced:r.updateAdvanced},null,8,["initial-bottom-height","initial-top-height","initial-border-thickness","onUpdateAdvanced"]),bt(c,{"initial-enable-back-hole":s.enableBackHole,"initial-back-hole-x-offset":s.backHoleXOffset,"initial-back-hole-width":s.backHoleWidth,"initial-back-hole-height":s.backHoleHeight,"initial-enable-front-hole":s.enableFrontHole,"initial-front-hole-x-offset":s.frontHoleXOffset,"initial-front-hole-width":s.frontHoleWidth,"initial-front-hole-height":s.frontHoleHeight,"initial-enable-right-hole":s.enableRightHole,"initial-right-hole-x-offset":s.rightHoleXOffset,"initial-right-hole-width":s.rightHoleWidth,"initial-right-hole-height":s.rightHoleHeight,"initial-enable-left-hole":s.enableLeftHole,"initial-left-hole-x-offset":s.leftHoleXOffset,"initial-left-hole-width":s.leftHoleWidth,"initial-left-hole-height":s.leftHoleHeight,onUpdateHoleOptions:r.updateHoleOptions},null,8,["initial-enable-back-hole","initial-back-hole-x-offset","initial-back-hole-width","initial-back-hole-height","initial-enable-front-hole","initial-front-hole-x-offset","initial-front-hole-width","initial-front-hole-height","initial-enable-right-hole","initial-right-hole-x-offset","initial-right-hole-width","initial-right-hole-height","initial-enable-left-hole","initial-left-hole-x-offset","initial-left-hole-width","initial-left-hole-height","onUpdateHoleOptions"]),j("button",{onClick:e[0]||(e[0]=(...u)=>r.downloadModel&&r.downloadModel(...u)),class:"mt-4 px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 block mx-auto"}," Download file ")]),bt(f)])}const T4=pr(E4,[["render",w4]]);g1(T4).mount("#app");
