...
`)}function fw(t,e){const n={},i=t.getProgramParameter(e,t.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=t.getActiveAttrib(e,s),o=r.name;let a=1;r.type===t.FLOAT_MAT2&&(a=2),r.type===t.FLOAT_MAT3&&(a=3),r.type===t.FLOAT_MAT4&&(a=4),n[o]={type:r.type,location:t.getAttribLocation(e,o),locationSize:a}}return n}function Vr(t){return t!==""}function cd(t,e){const n=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return t.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function fd(t,e){return t.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const uw=/^[ \t]*#include +<([\w\d./]+)>/gm;function df(t){return t.replace(uw,hw)}function hw(t,e){const n=ke[e];if(n===void 0)throw new Error("Can not resolve #include <"+e+">");return df(n)}const dw=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ud(t){return t.replace(dw,pw)}function pw(t,e,n,i){let s="";for(let r=parseInt(e);r<parseInt(n);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function hd(t){let e="precision "+t.precision+` float;
...
`].filter(Vr).join(`
`)),o=df(o),o=cd(o,n),o=fd(o,n),a=df(a),a=cd(a,n),a=fd(a,n),o=ud(o),a=ud(a),n.isWebGL2&&n.isRawShaderMaterial!==!0&&(S=`#version 300 es
...
`)},P_=t=>`${t[0]} ${t[1]} ${t[2]}`,Wc=t=>`vertex ${P_(t)}`,w4=t=>{const e=[];if(t.vertices.length>=3){const n=Wc(t.vertices[0]);for(let i=0;i<t.vertices.length-2;i++){const s=`facet normal ${P_(C_.poly3.plane(t))}
outer loop
${n}
${Wc(t.vertices[i+1])}
${Wc(t.vertices[i+2])}
...
`)}catch(l){return console.error("Error generating geometry or STL:",l),null}},createInitialMesh(){const t=this.generateSTL(this.width,this.depth,this.safety,this.bottomHeight,this.topHeight,this.borderThickness);if(!t)return;this.stlData=t;const n=new Ad().parse(t),i=new Jw({color:11066076,roughness:.6,metalness:.1});this.mesh=new vi(n,i),this.scene.add(this.mesh);const s=new Ed(n),r=new pf({color:3355443});this.edgeLines=new Md(s,r),this.scene.add(this.edgeLines)},rebuildMesh(){this.mesh&&(this.scene.remove(this.mesh),this.mesh.geometry.dispose()),this.edgeLines&&(this.scene.remove(this.edgeLines),this.edgeLines.geometry.dispose()),this.createInitialMesh()},animateDimensionsTransition(t,e){const n=performance.now(),i=this.tweenDuration,s=new Ad,r=o=>{const a=Math.min((o-n)/i,1),l={};for(const f of Object.keys(t))l[f]=t[f]+(e[f]-t[f])*a;const c=this.generateSTL(l.width,l.depth,l.safety,l.bottomHeight,l.topHeight,l.borderThickness);if(c){const f=s.parse(c);this.mesh&&(this.mesh.geometry.dispose(),this.mesh.geometry=f),this.edgeLines&&(this.scene.remove(this.edgeLines),this.edgeLines.geometry.dispose());const u=new Ed(f);this.edgeLines=new Md(u,new pf({color:3355443})),this.scene.add(this.edgeLines),this.stlData=c}a<1?requestAnimationFrame(r):(this.currentWidth=e.width,this.currentDepth=e.depth,this.currentSafety=e.safety,this.currentBottomHeight=e.bottomHeight,this.currentTopHeight=e.topHeight,this.currentBorderThickness=e.borderThickness)};requestAnimationFrame(r)},initScene(){this.scene=new Zw,this.camera=new bn(75,600/500,.1,1e3),this.camera.position.set(0,150,100),this.camera.up.set(0,0,1),this.camera.lookAt(0,0,10),this.renderer=new g0({canvas:this.$refs.canvas,antialias:!0}),this.renderer.setSize(600,500),this.renderer.setClearColor(16250871),this.scene.add(new oT(7368816,.5));const n=new iT(16777215,4473924,.6);n.position.set(0,200,0),this.scene.add(n);const i=new Td(16777215,.8);i.position.set(1,1,1).normalize(),this.scene.add(i);const s=new Td(16777215,.4);s.position.set(-1,-1,1).normalize(),this.scene.add(s),this.controls=new aT(this.camera,this.renderer.domElement),this.controls.rotateSpeed=1,this.controls.zoomSpeed=1.2,this.controls.panSpeed=.2,this.controls.dynamicDampingFactor=.05,this.controls.minPolarAngle=Math.PI/4,this.controls.maxPolarAngle=Math.PI/2,this.animate()},animate(){requestAnimationFrame(this.animate.bind(this)),this.controls.update(),this.renderer.render(this.scene,this.camera)},downloadSTL(){if(!this.stlData)return;const t=new Blob([this.stlData],{type:"application/octet-stream"}),e=document.createElement("a");e.href=URL.createObjectURL(t),e.download=`SynthArmor_cover_${this.width}x${this.depth}_safetyOffset${this.safety}_bottomHeight${this.bottomHeight}_topHeight${this.topHeight}_borderThickness${this.borderThickness}.stl`,e.click()}}},O4={class:"mt-2 mb-2 flex flex-col items-center"},H4={class:"w-full max-w-[600px] flex flex-col items-center"},B4={ref:"canvas",class:"rounded-md w-full max-w-[600px] border border-gray-300 border-t-0 border-b-0"};function z4(t,e,n,i,s,r){return tn(),mn("div",O4,[j("div",H4,[e[0]||(e[0]=j("div",{class:"bg-gray-300 h-[1px] w-[95%]"},null,-1)),j("canvas",B4,null,512),e[1]||(e[1]=j("div",{class:"bg-gray-300 h-[1px] w-[95%]"},null,-1))])])}const V4=pr(F4,[["render",z4]]),k4={name:"FAQ",data(){return{faqs:[{question:"What is this?",answer:"This web app lets you quickly generate a custom 3D model for gear cover protection. Simply enter your equipment’s dimensions, adjust a safety offset if needed, and download an STL file ready for 3D printing.",open:!1},{question:"How does it work?",answer:`
          ...
          `,open:!1},{question:"A Word of Caution",answer:"Please note that you are solely responsible for ensuring that the generated model fits your machine. Always double-check the dimensions before printing.",open:!1}]}},methods:{toggle(t){this.faqs[t].open=!this.faqs[t].open}}},G4={class:"w-full max-w-[600px] mt-8"},$4=["onClick"],W4={class:"text-lg font-medium text-gray-700"},X4={class:"px-6 py-4 bg-gray-50"},q4=["innerHTML"];function j4(t,e,n,i,s,r){return tn(),mn("div",G4,[e[1]||(e[1]=j("h2",{class:"text-2xl font-bold mb-6 text-gray-800 text-center"},"FAQ",-1)),(tn(!0),mn(Nn,null,Gv(s.faqs,(o,a)=>(tn(),mn("div",{key:a,class:"mb-4 border border-gray-200 rounded-lg overflow-hidden shadow-sm"},[j("button",{onClick:l=>r.toggle(a),class:"w-full flex items-center justify-between px-6 py-4 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"},[j("span",W4,Pf(o.question),1),(tn(),mn("svg",{class:Ga(["w-5 h-5 text-gray-500 transform transition-transform duration-300",{"rotate-180":o.open}]),fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},e[0]||(e[0]=[j("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M19 9l-7 7-7-7"},null,-1)]),2))],8,$4),bt(Gx,{name:"faq-collapse"},{default:ng(()=>[Ge(j("div",X4,[j("div",{innerHTML:o.answer,class:"text-gray-600"},null,8,q4)],512),[[Yx,o.open]])]),_:2},1024)]))),128))])}const Y4=pr(k4,[["render",j4],["__scopeId","data-v-9b75b70f"]]),Z4={name:"HoleOptionsForm",props:{initialEnableBackHole:{type:Boolean,default:!1},initialBackHoleXOffset:{type:Number,default:0},initialBackHoleWidth:{type:Number,default:55},initialBackHoleHeight:{type:Number,default:10},initialEnableFrontHole:{type:Boolean,default:!1},initialFrontHoleXOffset:{type:Number,default:0},initialFrontHoleWidth:{type:Number,default:55},initialFrontHoleHeight:{type:Number,default:10},initialEnableRightHole:{type:Boolean,default:!1},initialRightHoleXOffset:{type:Number,default:0},initialRightHoleWidth:{type:Number,default:55},initialRightHoleHeight:{type:Number,default:10},initialEnableLeftHole:{type:Boolean,default:!1},initialLeftHoleXOffset:{type:Number,default:0},initialLeftHoleWidth:{type:Number,default:55},initialLeftHoleHeight:{type:Number,default:10},bottomHeight:{type:Number,required:!0}},data(){return{local:{enableBackHole:this.initialEnableBackHole,backHoleXOffset:this.initialBackHoleXOffset,backHoleWidth:this.initialBackHoleWidth,backHoleHeight:this.initialBackHoleHeight,enableFrontHole:this.initialEnableFrontHole,frontHoleXOffset:this.initialFrontHoleXOffset,frontHoleWidth:this.initialFrontHoleWidth,frontHoleHeight:this.initialFrontHoleHeight,enableRightHole:this.initialEnableRightHole,rightHoleXOffset:this.initialRightHoleXOffset,rightHoleWidth:this.initialRightHoleWidth,rightHoleHeight:this.initialRightHoleHeight,enableLeftHole:this.initialEnableLeftHole,leftHoleXOffset:this.initialLeftHoleXOffset,leftHoleWidth:this.initialLeftHoleWidth,leftHoleHeight:this.initialLeftHoleHeight}}},watch:{local:{deep:!0,handler(){this.$emit("update-hole-options",{...this.local})}}}},K4={class:"mb-6 p-4 border border-gray-300 rounded"},J4={class:"grid grid-cols-1 md:grid-cols-2 gap-4"},Q4={class:"inline-flex items-center mb-2"},ez={key:0,class:"space-y-2"},tz={class:"flex items-center space-x-2"},nz={class:"flex items-center space-x-2"},iz={class:"flex items-center space-x-2"},sz=["max"],rz=["max"],oz={class:"inline-flex items-center mb-2"},az={key:0,class:"space-y-2"},lz={class:"flex items-center space-x-2"},cz={class:"flex items-center space-x-2"},fz={class:"flex items-center space-x-2"},uz=["max"],hz=["max"],dz={class:"inline-flex items-center mb-2"},pz={key:0,class:"space-y-2"},mz={class:"flex items-center space-x-2"},gz={class:"flex items-center space-x-2"},_z={class:"flex items-center space-x-2"},vz=["max"],xz=["max"],yz={class:"inline-flex items-center mb-2"},Mz={key:0,class:"space-y-2"},Ez={class:"flex items-center space-x-2"},Sz={class:"flex items-center space-x-2"},bz={class:"flex items-center space-x-2"},wz=["max"],Tz=["max"];function Az(t,e,n,i,s,r){return tn(),mn("fieldset",K4,[e[56]||(e[56]=j("legend",{class:"px-2 text-lg font-semibold"},"Hole Options",-1)),j("div",J4,[j("div",null,[j("div",Q4,[Ge(j("input",{type:"checkbox","onUpdate:modelValue":e[0]||(e[0]=o=>s.local.enableBackHole=o),class:"mr-2"},null,512),[[Ao,s.local.enableBackHole]]),e[28]||(e[28]=j("span",{class:"text-sm font-medium text-gray-700"},"Enable Back Hole",-1))]),s.local.enableBackHole?(tn(),mn("div",ez,[j("div",tz,[e[29]||(e[29]=j("label",{class:"w-24 text-sm text-gray-700"},"Position:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[1]||(e[1]=o=>s.local.backHoleXOffset=o),min:"-100",max:"100",step:"1",class:"flex-1"},null,512),[[Je,s.local.backHoleXOffset,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[2]||(e[2]=o=>s.local.backHoleXOffset=o),min:"-100",max:"100",step:"1",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.backHoleXOffset,void 0,{number:!0}]]),e[30]||(e[30]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",nz,[e[31]||(e[31]=j("label",{class:"w-24 text-sm text-gray-700"},"Width:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[3]||(e[3]=o=>s.local.backHoleWidth=o),min:"0",max:"300",step:"1",class:"flex-1"},null,512),[[Je,s.local.backHoleWidth,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[4]||(e[4]=o=>s.local.backHoleWidth=o),min:"0",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.backHoleWidth,void 0,{number:!0}]]),e[32]||(e[32]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",iz,[e[33]||(e[33]=j("label",{class:"w-24 text-sm text-gray-700"},"Height:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[5]||(e[5]=o=>s.local.backHoleHeight=o),min:"0",max:n.bottomHeight,step:"1",class:"flex-1"},null,8,sz),[[Je,s.local.backHoleHeight,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[6]||(e[6]=o=>s.local.backHoleHeight=o),min:"0",max:n.bottomHeight,class:"p-2 border border-gray-300 rounded-md w-16"},null,8,rz),[[Je,s.local.backHoleHeight,void 0,{number:!0}]]),e[34]||(e[34]=j("span",{class:"text-sm text-gray-700"},"mm",-1))])])):To("",!0)]),j("div",null,[j("div",oz,[Ge(j("input",{type:"checkbox","onUpdate:modelValue":e[7]||(e[7]=o=>s.local.enableFrontHole=o),class:"mr-2"},null,512),[[Ao,s.local.enableFrontHole]]),e[35]||(e[35]=j("span",{class:"text-sm font-medium text-gray-700"},"Enable Front Hole",-1))]),s.local.enableFrontHole?(tn(),mn("div",az,[j("div",lz,[e[36]||(e[36]=j("label",{class:"w-24 text-sm text-gray-700"},"Position:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[8]||(e[8]=o=>s.local.frontHoleXOffset=o),min:"-100",max:"100",step:"1",class:"flex-1"},null,512),[[Je,s.local.frontHoleXOffset,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[9]||(e[9]=o=>s.local.frontHoleXOffset=o),min:"-100",max:"100",step:"1",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.frontHoleXOffset,void 0,{number:!0}]]),e[37]||(e[37]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",cz,[e[38]||(e[38]=j("label",{class:"w-24 text-sm text-gray-700"},"Width:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[10]||(e[10]=o=>s.local.frontHoleWidth=o),min:"0",max:"300",step:"1",class:"flex-1"},null,512),[[Je,s.local.frontHoleWidth,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[11]||(e[11]=o=>s.local.frontHoleWidth=o),min:"0",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.frontHoleWidth,void 0,{number:!0}]]),e[39]||(e[39]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",fz,[e[40]||(e[40]=j("label",{class:"w-24 text-sm text-gray-700"},"Height:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[12]||(e[12]=o=>s.local.frontHoleHeight=o),min:"0",max:n.bottomHeight,step:"1",class:"flex-1"},null,8,uz),[[Je,s.local.frontHoleHeight,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[13]||(e[13]=o=>s.local.frontHoleHeight=o),min:"0",max:n.bottomHeight,class:"p-2 border border-gray-300 rounded-md w-16"},null,8,hz),[[Je,s.local.frontHoleHeight,void 0,{number:!0}]]),e[41]||(e[41]=j("span",{class:"text-sm text-gray-700"},"mm",-1))])])):To("",!0)]),j("div",null,[j("div",dz,[Ge(j("input",{type:"checkbox","onUpdate:modelValue":e[14]||(e[14]=o=>s.local.enableRightHole=o),class:"mr-2"},null,512),[[Ao,s.local.enableRightHole]]),e[42]||(e[42]=j("span",{class:"text-sm font-medium text-gray-700"},"Enable Right Hole",-1))]),s.local.enableRightHole?(tn(),mn("div",pz,[j("div",mz,[e[43]||(e[43]=j("label",{class:"w-24 text-sm text-gray-700"},"Position:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[15]||(e[15]=o=>s.local.rightHoleXOffset=o),min:"-100",max:"100",step:"1",class:"flex-1"},null,512),[[Je,s.local.rightHoleXOffset,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[16]||(e[16]=o=>s.local.rightHoleXOffset=o),min:"-100",max:"100",step:"1",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.rightHoleXOffset,void 0,{number:!0}]]),e[44]||(e[44]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",gz,[e[45]||(e[45]=j("label",{class:"w-24 text-sm text-gray-700"},"Width:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[17]||(e[17]=o=>s.local.rightHoleWidth=o),min:"0",max:"300",step:"1",class:"flex-1"},null,512),[[Je,s.local.rightHoleWidth,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[18]||(e[18]=o=>s.local.rightHoleWidth=o),min:"0",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.rightHoleWidth,void 0,{number:!0}]]),e[46]||(e[46]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",_z,[e[47]||(e[47]=j("label",{class:"w-24 text-sm text-gray-700"},"Height:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[19]||(e[19]=o=>s.local.rightHoleHeight=o),min:"0",max:n.bottomHeight,step:"1",class:"flex-1"},null,8,vz),[[Je,s.local.rightHoleHeight,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[20]||(e[20]=o=>s.local.rightHoleHeight=o),min:"0",max:n.bottomHeight,class:"p-2 border border-gray-300 rounded-md w-16"},null,8,xz),[[Je,s.local.rightHoleHeight,void 0,{number:!0}]]),e[48]||(e[48]=j("span",{class:"text-sm text-gray-700"},"mm",-1))])])):To("",!0)]),j("div",null,[j("div",yz,[Ge(j("input",{type:"checkbox","onUpdate:modelValue":e[21]||(e[21]=o=>s.local.enableLeftHole=o),class:"mr-2"},null,512),[[Ao,s.local.enableLeftHole]]),e[49]||(e[49]=j("span",{class:"text-sm font-medium text-gray-700"},"Enable Left Hole",-1))]),s.local.enableLeftHole?(tn(),mn("div",Mz,[j("div",Ez,[e[50]||(e[50]=j("label",{class:"w-24 text-sm text-gray-700"},"Position:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[22]||(e[22]=o=>s.local.leftHoleXOffset=o),min:"-100",max:"100",step:"1",class:"flex-1"},null,512),[[Je,s.local.leftHoleXOffset,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[23]||(e[23]=o=>s.local.leftHoleXOffset=o),min:"-100",max:"100",step:"1",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.leftHoleXOffset,void 0,{number:!0}]]),e[51]||(e[51]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",Sz,[e[52]||(e[52]=j("label",{class:"w-24 text-sm text-gray-700"},"Width:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[24]||(e[24]=o=>s.local.leftHoleWidth=o),min:"0",max:"300",step:"1",class:"flex-1"},null,512),[[Je,s.local.leftHoleWidth,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[25]||(e[25]=o=>s.local.leftHoleWidth=o),min:"0",class:"p-2 border border-gray-300 rounded-md w-16"},null,512),[[Je,s.local.leftHoleWidth,void 0,{number:!0}]]),e[53]||(e[53]=j("span",{class:"text-sm text-gray-700"},"mm",-1))]),j("div",bz,[e[54]||(e[54]=j("label",{class:"w-24 text-sm text-gray-700"},"Height:",-1)),Ge(j("input",{type:"range","onUpdate:modelValue":e[26]||(e[26]=o=>s.local.leftHoleHeight=o),min:"0",max:n.bottomHeight,step:"1",class:"flex-1"},null,8,wz),[[Je,s.local.leftHoleHeight,void 0,{number:!0}]]),Ge(j("input",{type:"number","onUpdate:modelValue":e[27]||(e[27]=o=>s.local.leftHoleHeight=o),min:"0",max:n.bottomHeight,class:"p-2 border border-gray-300 rounded-md w-16"},null,8,Tz),[[Je,s.local.leftHoleHeight,void 0,{number:!0}]]),e[55]||(e[55]=j("span",{class:"text-sm text-gray-700"},"mm",-1))])])):To("",!0)])])])}const Rz=pr(Z4,[["render",Az]]),Cz="/SynthArmor/dev/SynthArmor_logo.png",Pz={name:"App",components:{BasicForm:R1,AdvancedForm:H1,ModelViewer:V4,FAQ:Y4,HoleOptionsForm:Rz},data(){return{width:155,depth:105,safety:0,bottomHeight:15,topHeight:25,borderThickness:2.5,enableBackHole:!1,backHoleXOffset:0,backHoleWidth:55,backHoleHeight:10,enableFrontHole:!1,frontHoleXOffset:0,frontHoleWidth:55,frontHoleHeight:10,enableRightHole:!1,rightHoleXOffset:0,rightHoleWidth:55,rightHoleHeight:10,enableLeftHole:!1,leftHoleXOffset:0,leftHoleWidth:55,leftHoleHeight:10}},computed:{version(){return"197bf19eb32d511f4a112fb72a0d41e64ee80ecf"}},methods:{updateBasic({width:t,depth:e,safety:n}){this.width=t,this.depth=e,this.safety=n},updateAdvanced({bottomHeight:t,topHeight:e,borderThickness:n}){this.bottomHeight=t,this.topHeight=e,this.borderThickness=n},updateHoleOptions(t){Object.assign(this,t)},downloadModel(){this.$refs.modelViewer.downloadSTL()}}},Lz={class:"max-w-3xl mx-auto min-h-screen flex flex-col justify-center items-center p-6"},Dz={class:"w-full max-w-[600px] bg-white rounded shadow p-6"},Uz={class:"mt-4 text-sm text-gray-500 text-center"};function Iz(t,e,n,i,s,r){const o=br("BasicForm"),a=br("ModelViewer"),l=br("AdvancedForm"),c=br("HoleOptionsForm"),f=br("FAQ");return tn(),mn("div",Lz,[e[1]||(e[1]=j("img",{src:Cz,alt:"SynthArmor Logo",class:"w-40 mb-4"},null,-1)),e[2]||(e[2]=j("div",{class:"mb-8 text-center"},[j("p",{class:"text-gray-600"}," Modify the dimensions of a 3D model and download your custom design instantly. ")],-1)),j("div",Dz,[bt(o,{"initial-width":s.width,"initial-depth":s.depth,"initial-safety":s.safety,onUpdateDimensions:r.updateBasic},null,8,["initial-width","initial-depth","initial-safety","onUpdateDimensions"]),bt(a,{ref:"modelViewer",width:s.width,depth:s.depth,safety:s.safety,"bottom-height":s.bottomHeight,"top-height":s.topHeight,"border-thickness":s.borderThickness,"enable-back-hole":s.enableBackHole,"back-hole-x-offset":s.backHoleXOffset,"back-hole-width":s.backHoleWidth,"back-hole-height":s.backHoleHeight,"enable-front-hole":s.enableFrontHole,"front-hole-x-offset":s.frontHoleXOffset,"front-hole-width":s.frontHoleWidth,"front-hole-height":s.frontHoleHeight,"enable-right-hole":s.enableRightHole,"right-hole-x-offset":s.rightHoleXOffset,"right-hole-width":s.rightHoleWidth,"right-hole-height":s.rightHoleHeight,"enable-left-hole":s.enableLeftHole,"left-hole-x-offset":s.leftHoleXOffset,"left-hole-width":s.leftHoleWidth,"left-hole-height":s.leftHoleHeight},null,8,["width","depth","safety","bottom-height","top-height","border-thickness","enable-back-hole","back-hole-x-offset","back-hole-width","back-hole-height","enable-front-hole","front-hole-x-offset","front-hole-width","front-hole-height","enable-right-hole","right-hole-x-offset","right-hole-width","right-hole-height","enable-left-hole","left-hole-x-offset","left-hole-width","left-hole-height"]),bt(l,{"initial-bottom-height":s.bottomHeight,"initial-top-height":s.topHeight,"initial-border-thickness":s.borderThickness,onUpdateAdvanced:r.updateAdvanced},null,8,["initial-bottom-height","initial-top-height","initial-border-thickness","onUpdateAdvanced"]),bt(c,{"initial-enable-back-hole":s.enableBackHole,"initial-back-hole-x-offset":s.backHoleXOffset,"initial-back-hole-width":s.backHoleWidth,"initial-back-hole-height":s.backHoleHeight,"initial-enable-front-hole":s.enableFrontHole,"initial-front-hole-x-offset":s.frontHoleXOffset,"initial-front-hole-width":s.frontHoleWidth,"initial-front-hole-height":s.frontHoleHeight,"initial-enable-right-hole":s.enableRightHole,"initial-right-hole-x-offset":s.rightHoleXOffset,"initial-right-hole-width":s.rightHoleWidth,"initial-right-hole-height":s.rightHoleHeight,"initial-enable-left-hole":s.enableLeftHole,"initial-left-hole-x-offset":s.leftHoleXOffset,"initial-left-hole-width":s.leftHoleWidth,"initial-left-hole-height":s.leftHoleHeight,"bottom-height":s.bottomHeight,onUpdateHoleOptions:r.updateHoleOptions},null,8,["initial-enable-back-hole","initial-back-hole-x-offset","initial-back-hole-width","initial-back-hole-height","initial-enable-front-hole","initial-front-hole-x-offset","initial-front-hole-width","initial-front-hole-height","initial-enable-right-hole","initial-right-hole-x-offset","initial-right-hole-width","initial-right-hole-height","initial-enable-left-hole","initial-left-hole-x-offset","initial-left-hole-width","initial-left-hole-height","bottom-height","onUpdateHoleOptions"]),j("button",{onClick:e[0]||(e[0]=(...u)=>r.downloadModel&&r.downloadModel(...u)),class:"mt-4 px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 block mx-auto"}," Download file ")]),bt(f),j("footer",Uz,Pf(r.version),1)])}const Nz=pr(Pz,[["render",Iz]]);g1(Nz).mount("#app");
